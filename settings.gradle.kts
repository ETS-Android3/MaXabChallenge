...
dependencyResolutionManagement {
    versionCatalogs {
        create("libs") {
            ...
            version("dagger", "2.39.1")
            // Required by Android dynamic feature modules and SafeArgs
            alias("dagger-android-supportt").to("com.google.dagger", "dagger-android-support").versionRef("dagger")
            alias("dagger-androidd").to("com.google.dagger", "dagger-android").versionRef("dagger")
            alias("dagger-annotation").to("com.google.dagger", "dagger-android-processor").versionRef("dagger")
            alias("dagger-kapt").to("com.google.dagger", "dagger-compiler").versionRef("dagger")
            bundle("dagger", listOf("dagger-android-supportt", "dagger-androidd"))
